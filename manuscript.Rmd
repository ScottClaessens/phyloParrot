...
`r printnum(tar_read(auc), digits = 2)` (Supplementary Figure 
...
mechanical interface by using an object to manipulate another target or surface
[@Fragaszy2018]. This makes it difficult to dismiss self-scratching as 
...
captivity also use tools for other purposes in the wild [@Auersperg2012;
@Bastos2021;@Goodman2018;@OHara2021]. 
